package com.example.retrofitdaggerpost.Adapter
...
import com.example.retrofitdaggerpost.Model.Phone
import com.example.retrofitdaggerpost.databinding.EachRowBinding

import dagger.hilt.android.qualifiers.ApplicationContext
import javax.inject.Inject
class PhoneAdapter @Inject
constructor(private val listener: GnssAntennaInfo.Listener) : ListAdapter<Phone,PhoneAdapter.PhoneViewHolder>(Diff) {
